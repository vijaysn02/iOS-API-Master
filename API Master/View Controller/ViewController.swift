...
extension ViewController {
    ...
    func postAPICall(name:String,job:String) {
        ...
        ServiceInteraction.postAPICallwithParametersData(urlStringValue: urlString, callingVC: self, foregroundAPICall: true, parameters: parametersList) { (responseData) in
...
extension ViewController {
    ...
    func putAPICall(name:String,job:String) {
        ...
        ServiceInteraction.putAPICallwithParametersData(urlStringValue: urlString, callingVC: self, foregroundAPICall: true, parameters: parametersList) { (responseData) in
...
extension ViewController {
    ...
    func deleteAPICall(name:String,job:String) {
        ...
        ServiceInteraction.deleteAPICallwithParametersData(urlStringValue: urlString, callingVC: self, foregroundAPICall: true, parameters: parametersList) { (responseData) in
